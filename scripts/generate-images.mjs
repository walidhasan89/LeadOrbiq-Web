...
<svg width="1200" height="630" viewBox="0 0 1200 630" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <linearGradient id="brand" x1="0" y1="0" x2="1200" y2="630" gradientUnits="userSpaceOnUse">
      ...
      <stop offset="48%" stop-color="#8B5CFF"/>
      <stop offset="100%" stop-color="#38D6FF"/>
    </linearGradient>
    <radialGradient id="glow" cx="0.8" cy="0.15" r="0.6">
      <stop offset="0%" stop-color="rgba(56,214,255,0.35)"/>
      <stop offset="100%" stop-color="rgba(56,214,255,0)"/>
    </radialGradient>
  ...
  <!-- orbit ring motif -->
  <ellipse cx="960" cy="470" rx="260" ry="150" transform="rotate(-18 960 470)" fill="none" stroke="rgba(77,124,255,0.35)" stroke-width="2" stroke-dasharray="4 10"/>
  <circle cx="960" cy="470" r="70" fill="url(#brand)" opacity="0.9"/>
  <circle cx="1130" cy="360" r="16" fill="#38D6FF"/>
  <circle cx="810" cy="560" r="10" fill="#8B5CFF"/>

  <!-- logo mark -->
  <g transform="translate(96 92)">
    <ellipse cx="24" cy="24" rx="26" ry="15" transform="rotate(-24 24 24)" fill="none" stroke="url(#brand)" stroke-width="4"/>
    <circle cx="24" cy="24" r="11" fill="url(#brand)"/>
    <circle cx="24" cy="24" r="4.2" fill="#050816"/>
    <circle cx="45" cy="12" r="5" fill="#38D6FF"/>
  </g>
